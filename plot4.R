...
#Making Plots
  ...
  with(subsetData, lines(Time, Global_active_power))
  ...
  with(subsetData, plot(Time, 
                        ...
                        xlab = 'datetime',
                        ylab = 'Voltage'))
  with(subsetData, lines(Time, Voltage))
  ...
  with(subsetData, lines(Time, Global_reactive_power))
